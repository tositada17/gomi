...
import { gomiTreeProvider } from './gomi';
...
export function activate(context: vscode.ExtensionContext) {
	...
	const viewProvider = new ExplorerViewProvider(model,shellService);
	vscode.window.registerTreeDataProvider('gomiTree',viewProvider)
	const gomiTreeRefreshdisposable = vscode.commands.registerCommand("gomi.refresh",() => viewProvider.refresh())
